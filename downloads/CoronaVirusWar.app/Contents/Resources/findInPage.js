...
(function() {  
    ...
    const HIGHLIGHT_CLASS_NAME = "__flotato__find-highlight";
    const HIGHLIGHT_CLASS_NAME_ACTIVE = "__flotato__find-highlight-active";
    const HIGHLIGHT_CLASS_NAME_CLICKED = "__flotato__find-highlight-clicked";
    const HIGHLIGHT_CLASS_NAME_BUMP = "__flotato__find-highlight-bump";
    
    
    // const HIGHLIGHT_COLOR = "#ffde49";
    // const HIGHLIGHT_COLOR_ACTIVE = "#f19750";

    const HIGHLIGHT_COLOR = "#E6FF00";
    const HIGHLIGHT_COLOR_ACTIVE = "#FF4300";
    ...
    `.${HIGHLIGHT_CLASS_NAME} {
      ...
      border-radius: 1px;
      box-shadow: 0 0 0 2px ${HIGHLIGHT_COLOR}, 0px 0px 5px rgba(177, 197, 0, 1);
    ...
    color : white;
      ...
      box-shadow: 0 0 0 4px ${HIGHLIGHT_COLOR_ACTIVE}, 0px 0px 50px 5px rgb(187, 50, 0);
...
//        webkit.messageHandlers.findInPageHandler.postMessage({ totalResults: totalResults });
    ...
    function updateActiveHighlight() {
      ...
      if (activeHighlight) {
        activeHighlight.className = HIGHLIGHT_CLASS_NAME + " " + HIGHLIGHT_CLASS_NAME_ACTIVE + " " + HIGHLIGHT_CLASS_NAME_BUMP;
    ...
    function clickActiveHighlight(){
        let el = lastHighlights[activeHighlightIndex]
        el.classList.add(HIGHLIGHT_CLASS_NAME_CLICKED)
        el.click();        
    }
    ...
    Object.defineProperty(window.__flotato__, "find", {
      enumerable: false,
      configurable: false,
      writable: false,
      value: find
    ...
    Object.defineProperty(window.__flotato__, "clickActiveHighlight", {
        enumerable: false,
        configurable: false,
        writable: false,
        value: clickActiveHighlight
      });
      
    
    Object.defineProperty(window.__flotato__, "findNext", {
      enumerable: false,
      configurable: false,
      writable: false,
      value: findNext
    ...
    Object.defineProperty(window.__flotato__, "findPrevious", {
      enumerable: false,
      configurable: false,
      writable: false,
      value: findPrevious
    ...
    Object.defineProperty(window.__flotato__, "findDone", {
      enumerable: false,
      configurable: false,
      writable: false,
      value: findDone
