...
Object.defineProperty(window.__flotato__, "NightMode", {
  enumerable: false,
  configurable: false,
  writable: false,
  value: { enabled: false }
...
function applyInvertFilterToElement(el) {
  ...
  el.__flotato__NightMode_originalFilter = el.style.webkitFilter;
  el.style.webkitFilter = NIGHT_MODE_INVERT_FILTER_CSS;
}

function removeInvertFilterFromElement(el) {
  el.style.webkitFilter = el.__flotato__NightMode_originalFilter;
  delete el.__flotato__NightMode_originalFilter;
}
...
Object.defineProperty(window.__flotato__.NightMode, "setEnabled", {
  enumerable: false,
  configurable: false,
  writable: false,
  value: function(enabled) {
    if (enabled === window.__flotato__.NightMode.enabled) {
      return;
    }

    window.__flotato__.NightMode.enabled = enabled;
